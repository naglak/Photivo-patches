...
#ifndef PTFILTER_GreyCStoration_H
#define PTFILTER_GreyCStoration_H

#include "ptFilterBase.h"

class ptFilter_GreyCStoration: public ptFilterBase {
  Q_OBJECT

public:
  static ptFilterBase *createGreyCStoration();
...
private:
  ptFilter_GreyCStoration();
  
};

#endif // PTFILTER_GreyCStoration_H
