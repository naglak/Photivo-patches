...
#ifndef PTFILTER_LMHRecovery_H
#define PTFILTER_LMHRecovery_H
...
public:
  static ptFilterBase *createLMHRecoveryRgb();
  static ptFilterBase *createLMHRecoveryLab();
...
private:
  ...
  ptFilter_LMHRecovery(const QString &AFilterName, TColorSpace AColorSpace);
  
  TColorSpace FColorSpace;
};

#endif // PTFILTER_LMHRecovery_H
