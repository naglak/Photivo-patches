...
#ifndef PTFILTER_Defringe_H
#define PTFILTER_Defringe_H

#include "ptFilterBase.h"

class ptFilter_Defringe: public ptFilterBase {
  Q_OBJECT

public:
  static ptFilterBase *createDefringe();
