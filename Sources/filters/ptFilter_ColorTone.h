...
#ifndef PTFILTER_ColorTone_H
#define PTFILTER_ColorTone_H

#include "ptFilterBase.h"

class ptFilter_ColorTone: public ptFilterBase {
  Q_OBJECT

public:
  static ptFilterBase* createColorTone();
