...
#ifndef PTFILTER_GradualOverlay_H
#define PTFILTER_GradualOverlay_H

#include "ptFilterBase.h"

class ptFilter_GradualOverlay: public ptFilterBase {
  Q_OBJECT

public:
  static ptFilterBase* createGradualOverlay();
...
private:
  ptFilter_GradualOverlay();
  
};

#endif // PTFILTER_GradualOverlay_H
